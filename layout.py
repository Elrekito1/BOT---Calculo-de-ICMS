...
# Classe com as funcionalidades dos Frames
class App(tk.Tk):
    ...
    def __init__(self):
        ...
        self.iconbitmap("C:\Antecipacao-ICMS\logo.ico")
    ...
    # Função para centralizar o frame
    ...
    # Função para selecionar a pasta com os arquivos XMLs
    ...
    # Função para selecionar a planilha XLS ou XLSX
    def select_sheet(self):
        self.file_sheet = filedialog.askopenfilename(filetypes=[("Arquivos XLS", "*.xls"), ("Arquivos XLSX", "*.xlsx")])

    # Função para processar o diretório de XMLs
    ...
    # Função para atualizar progresso da barra
    ...
    # Função para processar o diretório de XMLs em segundo plano
    ...
    # Função para fazer o download do arquivo alterado
    ...
    # Função para retornar para o frame inicial
